...
ggplot(data = gapminder, aes(x = continent, y = lifeExp, colour = continent)) + 
  geom_boxplot() + facet_wrap(~ year) + scale_x_discrete(breaks=c("Africa", "Americas", "Asia", "Europe", "Oceania"),labels=c("Af", "Am", "As", "Eu", "Oc"))
...
# b.
ggplot(gapminder, aes(x = lifeExp, fill = continent)) + 
  geom_density() + facet_wrap(~continent) + geom_vline(data = lifeExp_Cont,aes(xintercept = c(48.87,64.59,60.06, 71.90, 74.33)))
